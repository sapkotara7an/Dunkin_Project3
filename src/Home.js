...
<Button variant="outline-dark" className=' bg-dark' ><img src={require('../src/img/GooglePlayStore.png')} className='w-100'/></Button></div>
  ...
  <div className='col-lg-6 col-md-12 col-sm-12'>
    ...
    <div className=' ban3 container-fluid text-center'>
      <div className='row '>
        <div className='col-lg-4 col-md-12  col-sm-12 py-5 px-2  ban3_img'>
          <p className='pictext_ban3'>Sipping is Believing</p>
          <Link to={'/coffee'}>
          <h2 className='subtitle'>
          HAND CRAFTED ESPRESSO DRINKS</h2>
           <img src={require('../src/img/Expresso.jpg')}/></Link>
            </div>
        ...
        <img src={require('../src/img/Bacon_Egg.png')} />
        </Link>
        </div>
        ...
        <Link to={'/coffee'}>
          <h2 className='subtitle'>
          HOT COFFEE</h2>
        <img src={require('../src/img/coffee.jpg')} />
        </Link>
        </div>
      </div>
    </div>
